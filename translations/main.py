...
async def transcribe_audio(
    ...
    try:
        ...
        if response_format == "json":
            ...
            raise AudioTranslationError(f"Unsupported response format: {response_format}")
...
async def translate_audio(
    ...
    model: Literal["whisper-large-v3"] = Form(default="whisper-large-v3", description="Whisper model to use"),
    prompt: Optional[str] = Form(default=None, description="Optional prompt for transcription"),
